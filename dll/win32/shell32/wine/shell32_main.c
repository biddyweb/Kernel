...
const char * const SHELL_Authors[] = { "Copyright 1993-"COPYRIGHT_YEAR" WINE Team", "Copyright 1998-"COPYRIGHT_YEAR" ReactOS Team", "Copyright "COPYRIGHT_YEAR" Greentea Team", 0 };
